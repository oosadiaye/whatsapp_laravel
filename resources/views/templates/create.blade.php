                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <select id="category"
                                    ...
                                    <option value="promotional" {{ old('category') === 'promotional' ? 'selected' : '' }}>{{ __('Promotional') }}</option>
                                    <option value="transactional" {{ old('category') === 'transactional' ? 'selected' : '' }}>{{ __('Transactional') }}</option>
                                    <option value="reminder" {{ old('category') === 'reminder' ? 'selected' : '' }}>{{ __('Reminder') }}</option>
                                </select>
                                @error('category')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            {{-- Media Upload --}}
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('Media Attachment (optional)') }}</label>
                                <input type="file"
                                       name="media"
                                ...
                                <p class="mt-1 text-xs text-gray-400">{{ __('Supported: Images, PDF, Audio') }}</p>
                                @error('media')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
